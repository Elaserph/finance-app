...
Please follow the steps, by default, the project will build using `dev` maven profile:
...
#### Once the whole project build is done, navigate to `currency-exchange` directory:
...
#### Once both services are up and running, following are the relevant resources to access/test them:
...
## Requirements, Architecture and Code Coverage
...
To access the latest aggregated report after a **clean build**: <br>
